...
const eligible = Object.freeze({
  ...
  amazonCategoryEligibilityProven: true,
  identifierRequirementResolved: true,
  fulfilmentModelResolved: true,
...
const cases = [
  ...
  ['unknown Amazon category eligibility fails closed', { amazonCategoryEligibilityProven: false }, OUTPUTS.HOLD],
  ['unresolved GTIN or identifier requirement fails closed', { identifierRequirementResolved: false }, OUTPUTS.HOLD],
  ['unresolved FBA or FBM fulfilment model fails closed', { fulfilmentModelResolved: false }, OUTPUTS.HOLD],
