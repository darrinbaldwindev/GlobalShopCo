...
const cases = [
  ...
  ['generic evidence conflict fails closed', { evidenceConflict: true }, OUTPUTS.HOLD],
  ...
  ['conflicting marketplace permission fails closed despite PROVEN value', { marketplacePermissionConflict: true }, OUTPUTS.HOLD],
  ['missing seller-of-record evidence fails closed', { sellerOfRecordEvidenceStatus: 'UNKNOWN' }, OUTPUTS.HOLD],
  ['conflicting seller-of-record evidence fails closed despite PROVEN value', { sellerOfRecordEvidenceConflict: true }, OUTPUTS.HOLD],
